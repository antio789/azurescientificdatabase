...
const {getMainFields, getChild, getArticlesWithAuthors} = require('../models/articles.js');
...
router.post('/', (req, res) => {
    try {
        ...
        const art2 = getArticlesWithAuthors(...req.body.filters);
        //console.log(art2);
...
router.post('/refresh', (req, res) => {
    const Articles = getArticlesWithAuthors(...req.body.filters);
    //console.log(Articles);
